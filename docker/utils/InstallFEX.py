...
# based on original FEX install script, removed root fs download and fex-emu-bin for installing in a docker container
...
def main():
    ...
    print ("FEX is now installed. Run 'FEXRootFSFetcher' to download and configure a RootFS")
    ExitWithStatus(0)
